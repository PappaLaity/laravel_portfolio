    ...
    <HomeLayout>
        <div class="w-full px-6 py-6 mx-auto loopple-min-height-78vh text-slate-500">
            ...
            <div class="w-full p-3 mt-6 mx-auto removable">
                <div class="flex flex-wrap -mx-3">
                    <div class="w-full max-w-full px-3 xl:w-4/12 mb-4">
                        <div
                                ...
                                <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                                    <li
                                        ...
                                        <div
                                            ...
                                            <img src="https://demos.creative-tim.com/soft-ui-dashboard-tailwind/assets/img/kal-visuals-square.jpg"
                                    ...
                                    <li
                                        ...
                                        <div
                                            class="inline-flex items-center justify-center w-12 h-12 mr-4 text-white transition-all duration-200 text-size-base ease-soft-in-out rounded-xl">
                                            <img src="https://demos.creative-tim.com/soft-ui-dashboard-tailwind/assets/img/marie.jpg"
                                                alt="kal" class="w-full shadow-soft-2xl rounded-xl">
                                        </div>
                                        <div class="flex flex-col items-start justify-center">
                                    ...
                                    <li
                                        ...
                                        <div
                                            class="inline-flex items-center justify-center w-12 h-12 mr-4 text-white transition-all duration-200 text-size-base ease-soft-in-out rounded-xl">
                                            <img src="https://demos.creative-tim.com/soft-ui-dashboard-tailwind/assets/img/ivana-square.jpg"
                                                alt="kal" class="w-full shadow-soft-2xl rounded-xl">
                                        </div>
                                        <div class="flex flex-col items-start justify-center">
                                    ...
                                    <li
                                        ...
                                        <div
                                            class="inline-flex items-center justify-center w-12 h-12 mr-4 text-white transition-all duration-200 text-size-base ease-soft-in-out rounded-xl">
                                            <img src="https://demos.creative-tim.com/soft-ui-dashboard-tailwind/assets/img/team-3.jpg"
                                                alt="kal" class="w-full shadow-soft-2xl rounded-xl">
                                        </div>
                                        <div class="flex flex-col items-start justify-center">
